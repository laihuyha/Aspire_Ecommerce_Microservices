...
namespace Catalog.Domain.Entities
{
    ...
    public class Variant : BaseEntity<Guid>
    {
            ...
            IEnumerable<ProductAttr> attributes = null)
        {
            ...
            Variant variant = new(name.Trim(), sku.Trim(), price, stockQuantity);

            if (attributes != null)
            {
                foreach (ProductAttr attribute in attributes)
                {
        ...
        public void UpdateDetails(string name, string sku, IEnumerable<ProductAttr> attributes)
        {
            ...
            _attributes.Clear();
            foreach (ProductAttr attribute in attributes ?? Enumerable.Empty<ProductAttr>())
            {
        ...
        public void AddAttribute(ProductAttr attribute)
        {
            ...
            {
                throw new DomainException($"Attribute '{attribute.Name}' already exists for this variant");
            }
        ...
        public void UpdateAttribute(ProductAttr updatedAttribute)
        {
            ...
            {
                throw new DomainException(
                    $"Attribute '{updatedAttribute.Name}' does not exist for this variant");
            }
        ...
        private static void ValidateName(string name)
        {
            ...
            {
                throw new DomainException("Variant name cannot be empty or whitespace");
            }
        ...
        private static void ValidateSKU(string sku)
        {
            ...
            {
                throw new DomainException("SKU cannot be empty or whitespace");
            }
            ...
            {
                throw new DomainException("SKU can only contain letters, numbers, hyphens, and underscores");
            }
        }
        ...
        private static void ValidatePrice(decimal price)
        {
            if (price < 0)
            {
                throw new DomainException("Variant price cannot be negative");
            }

            if (price > 999999.99m)
            {
                throw new DomainException("Variant price cannot exceed 999,999.99");
            }
        }
        ...
        private static void ValidateStockQuantity(int quantity)
        {
            ...
            if (quantity > 999999)
            {
                throw new DomainException("Stock quantity cannot exceed 999,999");
            }
        }
    }
}
