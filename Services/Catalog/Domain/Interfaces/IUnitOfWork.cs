...
namespace Catalog.Domain.Interfaces
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        Task<T> GetSingleBySpecAsync<T>(ISpecification<T> specification, CancellationToken cancellationToken = default)
            where T : class;

        Task<List<T>> GetListBySpecAsync<T>(ISpecification<T> specification,
            CancellationToken cancellationToken = default) where T : class;

        Task<PaginatedResult<T>> GetPaginatedBySpecAsync<T>(ISpecification<T> specification, int pageNumber,
    ...
    public interface IRepository<T> where T : class
    {
        ...
        Task<PaginatedResult<T>> GetPaginatedAsync(ISpecification<T> specification, int pageNumber, int pageSize,
    ...
    public interface IProductRepository : IRepository<Product>
    {
        ...
        Task<List<Product>> GetProductsInStockAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default);

        Task<List<Product>> SearchProductsAsync(string searchTerm, Guid? categoryId, CancellationToken cancellationToken = default);

        Task<bool> ExistSkusAsync(IEnumerable<string> skus, CancellationToken cancellationToken = default);
    }
}
